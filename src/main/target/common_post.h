...
#if (defined(USE_FLASH_W25M512) || defined(USE_FLASH_W25Q128FV) || defined(USE_FLASH_PY25Q128HA) || defined(USE_FLASH_UC25IQ128)) && !defined(USE_FLASH_M25P16)
...
// Generate USE_SPI_GYRO
    ...
    || defined(USE_ACCGYRO_LSM6DSV16X) || defined(USE_ACCGYRO_LSM6DSO) || defined(USE_ACCGYRO_LSM6DSK320X) || defined(USE_ACCGYRO_SCH16T) \
    || defined(USE_ACCGYRO_ICM40609D) || defined(USE_ACCGYRO_IIM42652) || defined(USE_ACCGYRO_ICM40608)
#ifndef USE_SPI_GYRO
#define USE_SPI_GYRO
#endif
#endif
